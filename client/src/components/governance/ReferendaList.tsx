...
const ReferendaList = ({ 
  ...
  const [modalReferendum, setModalReferendum] = useState<Referendum | null>(null);
  ...
  const openReferendumModal = (referendum: Referendum, e: React.MouseEvent) => {
    e.stopPropagation();
    setModalReferendum(referendum);
    setModalOpen(true);
  };
  ...
  return (
    <>
                ...
                <div className="mt-4 p-3 bg-gray-100 dark:bg-gray-600 rounded-lg transition-all">
                  ...
                  <div className="mt-3 flex justify-between items-center">
                    ...
                    <Button 
                      ...
                      size="sm" 
                      className="text-xs"
                      onClick={(e) => openReferendumModal(referendum, e)}
                    >
      ...
      {/* Modal for full referendum details */}
      <ReferendumModal 
        referendum={modalReferendum} 
        open={modalOpen} 
